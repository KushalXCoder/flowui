    ...
    return (
        <>
            <motion.div
                ...
                className="absolute top-0 left-0 w-full h-px origin-left border-t border-dashed border-gray-600 z-10"
            />
            <motion.div
                initial={{ translateX: "100%" }}
                animate={{ translateX: "0%" }}
                transition={{ duration: 1.2, ease: "easeInOut", delay: 1.2 }}
                className="absolute bottom-0 left-0 w-full h-px origin-left border-b border-dashed border-gray-600 z-10"
            />
            <motion.div
