...
export default function ScrollbarDemo() {
    return (
        <div className="relative w-full h-[100px] bg-muted rounded-lg overflow-hidden flex items-center justify-center border">
            <p className="text-muted-foreground text-sm">Scroll the page to see the bar fill</p>
            {/* Override fixed positioning to show inside the container */}
