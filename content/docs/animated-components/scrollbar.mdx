...
<div className="w-full flex items-center justify-center min-h-[350px] relative rounded-xl border bg-card text-card-foreground shadow-sm overflow-hidden">
    <ScrollbarDemo />
</div>
...
<div className="flex items-center justify-center p-6 border rounded-lg mt-4 mb-2 relative overflow-hidden h-24 bg-muted">
    <DefaultExample />
</div>
