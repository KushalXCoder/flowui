...
import TextDividerDemo from "@/components/previews/text-divider-demo";
import { BasicExample, ColorExample, StylingExample, IconExample } from "@/components/previews/text-divider-examples";

<div className="w-full flex items-center justify-center min-h-[350px] rounded-xl border bg-card text-card-foreground shadow-sm px-6 py-12">
    <TextDividerDemo />
</div>
...
You can easily adapt the pattern to include icons by customizing the content.
...
export function IconExample() {
    return (
        <div className="flex flex-col gap-8 w-full">
            {/* Custom structure manually creating lines if needed, or using TextDivider for simplicity */}
