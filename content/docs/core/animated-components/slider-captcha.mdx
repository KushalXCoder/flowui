...
import {
    ...
    SliderCaptchaForm,
    SliderCaptchaSoft,
} from "@/components/previews/slider-captcha/slider-captcha-examples";
...
<div className="w-full min-h-[220px] flex items-center justify-center rounded-xl border bg-card text-card-foreground shadow-sm p-6">
    <SliderCaptchaInline />
</div>
...
<div className="w-full min-h-[360px] flex items-center justify-center rounded-xl border bg-card text-card-foreground shadow-sm p-6">
    <SliderCaptchaForm />
</div>
